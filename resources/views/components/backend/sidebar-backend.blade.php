<aside class="w-64 mt-4 mx-4" aria-label="Sidebar">
    <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded-xl border-b shadow-md dark:bg-gray-800">
        <ul class="space-y-2">
            ...
            <li>
                <x-admin-nav-link :href="route('admin.highlight.index')" :active="request()->routeIs('admin.highlight.index')">
                    <svg aria-hidden="true" class="w-6 h-6 mr-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                    </svg>
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <x-admin-nav-link :href="route('admin.categories.index')" :active="request()->routeIs('admin.categories.index')" class="flex justify-center">{{ __('Category 1') }}</x-admin-nav-link>
                    </li>
                    <li>
                        <x-admin-nav-link :href="route('admin.categories.index')" :active="request()->routeIs('admin.categories.index')" class="flex justify-center">{{ __('Category 2') }}</x-admin-nav-link>
                    </li>
                    <li>
                        <x-admin-nav-link :href="route('admin.categories.index')" :active="request()->routeIs('admin.categories.index')" class="flex justify-center">{{ __('Category 3') }}</x-admin-nav-link>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-example-2" class="hidden py-2 space-y-2">
                    <li>
                        <x-admin-nav-link :href="route('admin.menus.index')" :active="request()->routeIs('admin.menus.index')" class="flex justify-center">{{ __('Menu 1') }}</x-admin-nav-link>
                    </li>
                    <li>
                        <x-admin-nav-link :href="route('admin.menus.index')" :active="request()->routeIs('admin.menus.index')" class="flex justify-center">{{ __('Menu 2') }}</x-admin-nav-link>
                    </li>
                    <li>
                        <x-admin-nav-link :href="route('admin.menus.index')" :active="request()->routeIs('admin.menus.index')" class="flex justify-center">{{ __('Menu 3') }}</x-admin-nav-link>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-admin-nav-link :href="route('logout')" onclick="event.preventDefault();
