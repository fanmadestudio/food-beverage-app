            ...
            <div class="grid grid-cols-2 justify-items-center">
                ...
                <div class="my-auto flex-none">
                    ...
                    <div class="flex justify-end items-center mb-4">
                        <x-frontend.search-btn />
                        <x-frontend.ordernow-btn />
                    </div>
                </div>
            ...
            <div class="flex min-h-screen items-center justify-center dark:bg-neutral-900">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div class="group relative items-center justify-center rounded-3xl overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow">
                        <div class="h-96 w-72">
                            <img class="h-full w-full object-cover group-hover:rotate-3 group-hover:scale-125 transition-transform duration-500" src="{{ Storage::url($menu->image) }}" />
                        </div>
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center px-9 text-center translate-y-[50%] group-hover:translate-y-0 transition-all">
                            ...
                            <p class="text-lg italic text-white mb-3 opacity-0 group-hover:opacity-100 transition-opacity">{{ $menu->description }}</p>
            ...
            <section class="container mx-auto px-8 overflow-hidden">
                <div class="flex flex-wrap justify-center gap-12 md:gap-6 lg:gap-20">
                    <div class="md:flex-1 md:max-w-sm flex">
                        <img class="mx-auto" src="{{ asset('img/cute-boy-girl-restaurant.svg') }}" alt="Image by mamewmy https://www.freepik.com/free-vector/cute-couple-barista-apron-standing-with-arms-crossed-cartoon-character-illustration_12158635.htm#query=chef&position=25&from_view=search&track=sph" />
                    </div>
