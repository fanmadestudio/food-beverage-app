<x-admin-layout>
    ...
    <div class="h-fit w-screen p-6 mt-4 mx-2 bg-white border-b border-gray-200 rounded-xl shadow-md sm:px-6 lg:px-8">
        ...
        <!-- Subtitle -->
        <h3 class="text-3xl">Edit {{ $reservation->first_name }} {{ $reservation->last_name }} Reservation</h3>
        ...
        <div class="m-4">
            <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <input id="first_name" name="first_name" type="text" value="{{ $reservation->first_name }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="First Name" required="" />
                </div>

                <!-- Last Name -->
                <div class="mb-8">
                    <label for="last_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Last Name</label>
                    <input id="last_name" name="last_name" type="text" value="{{ $reservation->last_name }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Last Name" required="" />
                </div>

                <!-- Email -->
                <div class="mb-8">
                    <label for="email" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Email</label>
                    <input id="email" name="email" type="text" value="{{ $reservation->email }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Email" required="" />
                </div>

                <!-- Reservation Date -->
                <div class="mb-8">
                    <label for="res_date" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Reservation Date</label>
                    <input id="res_date" name="res_date" type="datetime-local" value="{{ $reservation->res_date }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" required="" />
                </div>

                <!-- Telephone Number -->
                <div class="mb-8">
                    <label for="tel_number" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Telephone Number</label>
                    <input id="tel_number" name="tel_number" type="number" value="{{ $reservation->tel_number }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Telephone Number" required="" />
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div>
                        <select id="table_id" name="table_id" class="form-multiselect block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                            ...
                            <option value="{{ $table->id }}" @selected($table->id == $reservation->table_name)>{{ $table->table_name }} ({{ $table->guest_number }} Guests)</option>
                            @endforeach
                        </select>
                    </div>
                </div>
