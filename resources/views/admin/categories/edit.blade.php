<x-admin-layout>
    ...
    <div class="h-fit w-screen p-6 mt-4 mx-2 bg-white border-b border-gray-200 rounded-xl shadow-md sm:px-6 lg:px-8">
        ...
        <div class="flex mt-10 m-2 p-2">
            <a href="{{ route('admin.categories.index') }}" class="bg-sky-500 hover:bg-sky-500/60 text-white px-4 py-2 rounded-lg">Index Categories</a>
        </div>
        ...
        <div class="m-4">
            <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <input id="name" name="name" type="text" value="{{ $category->name }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Category Name" required="" />
                </div>
