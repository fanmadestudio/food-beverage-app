...
<?php $component->withAttributes([]); ?>
    ...
    <div class="h-fit w-screen p-6 mt-4 mx-2 bg-white border-b border-gray-200 rounded-xl shadow-md sm:px-6 lg:px-8">
        ...
        <!-- Subtitle -->
        <h3 class="text-3xl">Edit <?php echo e($menu->name); ?></h3>
        ...
        <div class="m-4">
            <form method="POST" action="<?php echo e(route('admin.menus.update', $menu->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <input id="name" name="name" type="text" value="<?php echo e($menu->name); ?>" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Menu Name" required="" />
                </div>
                ...
                <div class="mb-8">
                    ...
                    <input id="category" name="category" type="text" value="<?php echo e($menu->category); ?>" placeholder="Menu's Description" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" required="" />
                </div>

                <!-- Description -->
                <div class="mb-8">
                    <label for="description" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Description</label>
                    <input id="description" name="description" type="text" value="<?php echo e($menu->description); ?>" placeholder="Menu's Description" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" required="" />
                </div>

                <!-- Price -->
                <div class="mb-8">
                    <label for="price" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Price</label>
                    <input id="price" name="price" type="number" value="<?php echo e($menu->price); ?>" placeholder="Menu's Description" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" required="" />
                </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\foodnbeverage-app\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>