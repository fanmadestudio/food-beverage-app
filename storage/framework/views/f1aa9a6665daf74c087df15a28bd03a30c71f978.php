...
<?php $component->withAttributes([]); ?>
    ...
    <div class="h-fit w-screen p-6 mt-4 mx-2 bg-white border-b border-gray-200 rounded-xl shadow-md sm:px-6 lg:px-8">
        ...
        <!-- Subtitle -->
        <h3 class="text-3xl">Edit <?php echo e($table->name); ?></h3>

        <div class="flex mt-10 m-2 p-2">
            <a href="<?php echo e(route('admin.tables.index')); ?>" class="bg-sky-500 hover:bg-sky-500/60 text-white px-4 py-2 rounded-lg">Index Table</a>
        </div>


        <!-- Form -->
        <div class="m-4">
            <form method="POST" action="<?php echo e(route('admin.tables.update', $table->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8">
                    ...
                    <input id="table_name" name="table_name" type="text" value="<?php echo e($table->table_name); ?>" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Menu Name" required="" />
                </div>

                <!-- Guest Number -->
                <div class="mb-8">
                    <label for="guest_number" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Guest Number</label>
                    <input id="guest_number" name="guest_number" type="text" value="<?php echo e($table->guest_number); ?>" placeholder="Menu's Description" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" required="" />
                </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\foodnbeverage-app\resources\views/admin/tables/edit.blade.php ENDPATH**/ ?>