        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex justify-center">
...
<?php endif; ?> -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-glass-full" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-cheese" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <h3 class="ml-4 text-xl font-bold dark:text-white">Food & Beverage</h3>
                </div>
...
</nav><?php /**PATH D:\laragon\www\foodnbeverage-app\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>