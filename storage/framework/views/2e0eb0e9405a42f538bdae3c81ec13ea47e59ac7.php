...
<?php $component->withAttributes([]); ?>
    ...
    <div class="h-fit w-screen p-6 mt-4 mx-2 bg-white border-b border-gray-200 rounded-xl shadow-md sm:px-6 lg:px-8">
        ...
        <div class="flex justify-end mt-10 m-2 p-2">
            <a href="<?php echo e(route('admin.tables.create')); ?>" class="bg-sky-500 hover:bg-sky-500/60 text-white px-4 py-2 rounded-lg">New Table</a>
        </div>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                        ...
                        <td class="py-4 px-6 text-right">
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('admin.tables.edit', $table->id)); ?>" class="bg-sky-500 hover:bg-sky-500/50 rounded-xl px-4 py-2 font-medium text-white dark:text-white hover:underline">Edit</a>
                                <form class="bg-red-500 hover:bg-red-500/50 rounded-xl px-4 py-2 font-medium text-white dark:text-white hover:underline" method="POST" action="<?php echo e(route('admin.tables.destroy', $table->id)); ?>" onsubmit="return confirm('Are you sure?');">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\foodnbeverage-app\resources\views/admin/tables/index.blade.php ENDPATH**/ ?>